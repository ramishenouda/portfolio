...
import Foodeli from '/public/backgrounds/foodeli.png';
      ...
      <div className="flex flex-row relative">
        ...
        <div className="w-1/4">
          <Link
            ...
            className="hover:text-blue-300 w-full text-right transition-colors duration-500"
          >
            <h1>Foodeli</h1>
          </Link>
          <div className=" absolute right-0 max-w-[400px] z-50 justify-center items-center">
            ...
            <div className="bg-black/70 mt-3 p-3 text-xl font-bold rounded-sm">
              ...
              <div className="gap-8 z-50 flex mt-4 flex-row justify-center items-center w-full">
                <SiNestjs className="hover:text-black transition-colors duration-500" size={32} />
                <SiAngularjs className="hover:text-black transition-colors duration-500" size={32} />
                <SiTypescript className="hover:text-black transition-colors duration-500" size={32} />
                <SiCypress className="hover:text-black transition-colors duration-500" size={32} />
                <SiTailwindcss className="hover:text-black transition-colors duration-500" size={32} />
              </div>
