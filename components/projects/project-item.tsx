...
export const ProjectItem = ({ title, descriptionHeader, descriptionInfo, projectLink, reverseOrder }: props) => {
  return (
    <div className="min-h-[85vh] md:min-h-screen">
      <div className={`flex ${reverseOrder ? 'flex-row-reverse' : 'flex-row'} relative`}>
        ...
        <div className="md:w-1/4 md:z-1 z-50 w-full">
          ...
          <div
            className={`absolute right-0 max-w-[400px] z-50 justify-center items-center  ${
              reverseOrder ? 'left-0' : ''
            }`}
          >
