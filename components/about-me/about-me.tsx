export default function AboutMe() {
  return (
    <section id="about-me" className="min-h-[20vh] pt-10 text-white flex flex-col">
      <h1 className="section-title">ABOUT ME</h1>
      <p className="text-xl md:text-2xl line-he mt-4 tracking-wide leading-[140%] lg:w-[80vw]">
