      ...
      <div className="">
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-row items-center justify-center gap-8">
            <p onClick={() => getTestimonial(0)} className="cursor-pointer text-9xl">
              .
            </p>
            <p onClick={() => getTestimonial(1)} className="cursor-pointer text-9xl">
              .
            </p>
            <p onClick={() => getTestimonial(2)} className="cursor-pointer text-9xl">
              .
            </p>
          </div>
        </div>
